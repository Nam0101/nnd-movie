...
import com.nndmove.app.security.*;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/swagger-ui.html")).permitAll() // Add this line
                    .requestMatchers(mvc.pattern("/swagger-ui/**")).permitAll()) // Add this line
