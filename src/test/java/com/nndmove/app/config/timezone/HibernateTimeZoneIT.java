package com.nndmove.app.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.nndmove.app.IntegrationTest;
import com.nndmove.app.repository.timezone.DateTimeWrapper;
import com.nndmove.app.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM movie_date_time_wrapper where id=%d", fieldName, id);
    }
